# Not written by DGC
# Experiment to get this to work with codehilite. This is from commit 
# 38436802c1 at https://github.com/waylan/Python-Markdown
#
"""
    ...
    def hilite(self):
        ...
        if pygments_imported:
            try:
                ...
                try:
                    if self.guess_lang:
                        lexer = pygments.lexers.guess_lexer(self.src)
                    else:
            ...
            ret_val = pygments.highlight(self.src, lexer, formatter)
            return ret_val
        else:
